...
/**
 * Centralized Markdown renderer with:
...
export function MarkdownRenderer({
      ...
      if (type === 'checkbox') {
        return (
          <input
            ...
            disabled={disabled}
            readOnly
            className="mt-1 h-4 w-4 rounded border-slate-300 dark:border-slate-600 text-blue-600"
          />
        );
      }
  ...
  return (
    <div className={`lumio-markdown prose prose-sm dark:prose-invert max-w-none ${className}`}>
      <ReactMarkdown
