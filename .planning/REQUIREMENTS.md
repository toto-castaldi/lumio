...
- [ ] **INFRA-01**: Database trigger handles email signups (no Google metadata)
- [ ] **INFRA-02**: Sign-out works correctly for email-only users
- [ ] **INFRA-03**: Supabase config enables email confirmations and manual linking
- [ ] **INFRA-04**: OTP email templates customized with Lumio branding
- [ ] **INFRA-05**: Login screen shows Google OAuth button on top and email form below with separator
- [ ] **INFRA-06**: All new UI strings available in IT and EN
