...
Plans:
- [x] 07-01-PLAN.md — Generate PNG logo assets + integrate logo in Login screen and Dashboard header (BRAND-01, BRAND-02)
- [x] 07-02-PLAN.md — Add inline SVG logo to landing page header (BRAND-03)
